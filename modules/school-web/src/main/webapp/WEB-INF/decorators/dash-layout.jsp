...
<body>
    ...
    <script src="<c:url value="/resources/admin-theme/js/bootstrap-select.js"/>"></script>
    <script src="<c:url value="/resources/admin-theme/js/bootstrap.js"/>"></script>
    <script src="<c:url value="/resources/admin-theme/js/excanvas.min.js"/>"></script>
    <script language="javascript" type="text/javascript" src="<c:url value="/resources/admin-theme/js/chart.min.js"/>"></script>
    <script src="<c:url value="/resources/admin-theme/js/base.js"/>"></script>
    <script src="<c:url value="/resources/admin-theme/js/bootstrap-select.js"/>"></script>
    <script src="<c:url value="/resources/admin-theme/js/bootshop.js"/>"></script>
    <script src="<c:url value="/resources/admin-theme/google-code-prettify/prettify.js"/>"></script>
